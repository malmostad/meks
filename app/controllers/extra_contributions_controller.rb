class ExtraContributionsController < ApplicationController
  ...
  def create
    ...
    if @extra_contribution.save
      redirect_to @refugee, notice: 'Extra insatsen/extra kostnaden registrerades'
    else
      render :new
    end
  end
  ...
  def update
    ...
    if @extra_contribution.update(extra_contribution_params)
      redirect_to @refugee, notice: 'Extra insatsen/extra kostnaden uppdaterades'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to @refugee, notice: 'Extra insatsen/extra kostnaden raderades'
  end
