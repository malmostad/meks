class ExtraContributionsController < ApplicationController
  ...
  def create
    ...
    if @extra_contribution.save
      redirect_to refugee_show_economy_path(@refugee), notice: 'Extra insatsen registrerades'
    else
      render :new
    end
  end
  ...
  def update
    ...
    if @extra_contribution.update(extra_contribution_params)
      redirect_to refugee_show_economy_path(@refugee), notice: 'Extra insatsen uppdaterades'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to refugee_show_economy_path(@refugee), notice: 'Extra insatsen raderades'
  end
