class Ability
  ...
  def initialize(user)
    if user.has_role? :admin
      ...
      can %i[read show_placements show_economy show_relateds search suggest create edit update], Refugee
      ...
      can %i[read show_placements show_economy show_relateds search suggest], Refugee
