module Economy
  ...
  included do
    RATE_CATEGORIES = [
      { id: 1, name: 'Ankomstbarn',	from_age: 0, to_age: 17,
      ...
      { id: 3, name: 'Anvisade barn',	from_age: 0, to_age: 17,
        ...
        conditions: [age_0_to_17, legal_code_sol] },
      { id: 4, name: 'Anvisade barn',	from_age: 18, to_age: 20,
        desc: 'Lagrum SoL. Schablonen uterblir från och med 18-års dagen.',
        conditions: [age_18_to_20, legal_code_sol] },
      { id: 5, name: 'Barn med TUT',	from_age: 0, to_age: 17,
        ...
        conditions: [age_0_to_17, legal_code_sol] },
      { id: 6, name: 'Barn med TUT',	from_age: 18, to_age: 20,
        ...
        conditions: [age_18_to_20, legal_code_sol] },
      { id: 7, name: 'Barn med PUT',	from_age: 0, to_age: 17,
        ...
        conditions: [age_0_to_17, legal_code_sol] },
      { id: 8, name: 'Barn med PUT',	from_age: 18, to_age: 20,
