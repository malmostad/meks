...
RSpec.describe TargetGroupsController, type: :controller do
  ...
  # TargetGroup. As you add validations to TargetGroup, be sure to
  ...
  # TargetGroupsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created target_group" do
        post :create, {:target_group => valid_attributes}, valid_session
        expect(response).to redirect_to(TargetGroup.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the target_group" do
        target_group = TargetGroup.create! valid_attributes
        put :update, {:id => target_group.to_param, :target_group => valid_attributes}, valid_session
        expect(response).to redirect_to(target_group)
      end
    end
