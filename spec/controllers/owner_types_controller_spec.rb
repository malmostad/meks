...
RSpec.describe OwnerTypesController, type: :controller do
  ...
  # OwnerType. As you add validations to OwnerType, be sure to
  ...
  # OwnerTypesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created owner_type" do
        post :create, {:owner_type => valid_attributes}, valid_session
        expect(response).to redirect_to(OwnerType.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the owner_type" do
        owner_type = OwnerType.create! valid_attributes
        put :update, {:id => owner_type.to_param, :owner_type => valid_attributes}, valid_session
        expect(response).to redirect_to(owner_type)
      end
    end
