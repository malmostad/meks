  ...
  describe 'writer role' do
    ...
    describe 'Adds extra_contribution' do
      scenario 'for a refugee' do
        ...
        click_on 'Ny extra insats/extra kostnad'
        ...
        expect(page).to have_selector('.notice', text: 'Extra insatsen/extra kostnaden registrerades')
    ...
    describe 'Edit extra_contribution' do
      scenario 'for a refugee' do
        ...
        visit "/refugees/#{refugee.id}"
        click_link('Redigera extra insatsen/extra kostnaden')
        ...
        expect(current_path).to eq refugee_path(refugee)
        expect(page).to have_selector('.notice', text: 'Extra insatsen/extra kostnaden uppdaterades')
