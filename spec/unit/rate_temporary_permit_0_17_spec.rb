...
RSpec.describe 'Rates for temporary_permit_0_17' do
  ...
  let(:person) { create(:person_temporary_permit_0_17) }
  ...
  it 'should respond to changed temporary_permit_starts_at' do
    person.temporary_permit_starts_at = '2018-04-06'
  ...
  it 'should respond to changed temporary_permit_ends_at' do
    person.temporary_permit_starts_at = '2017-04-01'
    person.temporary_permit_ends_at = '2018-05-01'
  ...
  it 'should respond to date_of_birth' do
    person.date_of_birth = '2000-01-01'
  ...
  it 'should require ekb to be true' do
    person.ekb = false
    rates = Economy::RatesForPerson.new(person, UnitMacros::REPORT_INTERVAL).as_array
    rate = detect_rate_by_amount(rates, UnitMacros::RATES[:temporary_permit_0_17])
  ...
  describe 'deduction of days for placements with legal_code#exempt_from_rate' do
    ...
    it 'should not have rate_exempt because of citizenship' do
      person = create(:person_temporary_permit_0_17, citizenship_at: '2016-01-01')
      create(:placement_with_rate_exempt, person: person, moved_in_at: UnitMacros::REPORT_INTERVAL[:from].to_date + 1)
      rates = Economy::RatesForPerson.new(person, UnitMacros::REPORT_INTERVAL).as_array
      rate = detect_rate_by_amount(rates, UnitMacros::RATES[:temporary_permit_0_17])
