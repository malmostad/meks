...
```shell
$ bundle exec rspec --exclude-pattern "./spec/unit/{family_and_emergency_home_cost,extra_contribution_cost}_spec.rb,./spec/features/placements_spec.rb"
$ bundle exec rspec --pattern "./spec/unit/{family_and_emergency_home_cost,extra_contribution_cost}_spec.rb,./spec/features/placements_spec.rb,./spec/features/placements_spec.rb"
```
