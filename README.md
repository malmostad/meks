...
$ bundle exec rspec --pattern "./spec/unit/extra_contribution_cost_spec.rb" --pattern "./spec/unit/family_and_emergency_home_cost_spec.rb" --pattern "./spec/features/placements_spec.rb"
```
