...
ActiveRecord::Schema.define(version: 20151209110051) do
  ...
  create_table "homes_refugees", id: false, force: :cascade do |t|
    t.integer  "home_id",    limit: 4
    t.integer  "refugee_id", limit: 4
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
  ...
  add_index "homes_refugees", ["home_id"], name: "index_homes_refugees_on_home_id", using: :btree
  add_index "homes_refugees", ["refugee_id"], name: "index_homes_refugees_on_refugee_id", using: :btree
